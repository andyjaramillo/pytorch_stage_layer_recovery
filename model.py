...
import timeit
import traceback
from Stage import StagedModule
...
def test_loop(dataloader, model, loss_fn, total_time):
...
for i in range(1,epochs):
    ...
    test_loop(test_dataloader, model, loss_fn,total_time)
# def run():

#     train_loop(train_dataloader, model, loss_fn, optimizer)
#     test_loop(test_dataloader, model, loss_fn,total_time)

# staged_module = StagedModule(model, run, epochs)
# staged_module.run()
